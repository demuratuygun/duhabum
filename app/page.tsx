...
export default function Home() {
  return (
    <main style={{ width: "100vw", overflow: 'clip' }}>
      ...
      <div style={{ position: "fixed", right: 30, bottom: 30, zIndex:1000 }}><Logo type='big'/></div>

      <div style={{ position: "absolute", top: 0, left:0, display: 'flex', flexDirection: 'column', width: '100%', overflow: 'clip' }}>
        <IntroFrame />
        <MessageFrame />
        <PackageFrame />
        <TransitionFrame />
