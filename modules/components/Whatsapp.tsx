...
export default function whatsapp({}) {
    ...
    return (
      <>
      { textOpen? 
        <div className='box' style={{width:'300px', fontSize:'0.5rem', lineHeight: '1.5rem', fontWeight:'lighter', zIndex:1000, position:'fixed', left: '2rem', bottom: '2rem'}}> 
          <TextEnter focus={false} 
              Value={""}
              verify={""} 
              examples={["whatsapp'tan aklina takilan her seyi sorabilirsin", 'bir merhaba de sana donelim']}
              caret long
        ...
        <div > 
          ...
          }} id="whatsapp" href={"https://wa.me/message/54EF3YKBYGZGG1"} style={{ position:'fixed', left: '2rem', bottom: '2rem', zIndex:1000 }} >
